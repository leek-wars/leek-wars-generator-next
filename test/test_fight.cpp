...
void Test::test_fight() {
	...
	test_ai(fight, entity, "Field.cell(-17, 0)", "<Cell 0>");
	test_ai(fight, entity, "Field.cell(17, 0)", "<Cell 612>");
	test_ai(fight, entity, "Field.cell(0, 17)", "<Cell 595>");
	test_ai(fight, entity, "Field.cell(0, -17)", "<Cell 17>");
	test_ai(fight, entity, "Field.cell(306).x", "0");
