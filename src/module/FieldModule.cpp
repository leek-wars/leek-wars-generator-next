...
FieldModule::FieldModule() : Module("Field") {
	...
	method("path", ls::Method::Static, {{CellModule::array_type, {CellModule::type, CellModule::type}, (void*) &map_getPath}});
	method("distance", ls::Method::Static, {{ls::Type::integer(), {CellModule::type, CellModule::type}, (void*) &map_getDistance}});
	method("straightDistance", ls::Method::Static, {{ls::Type::real(), {CellModule::type}, (void*) &map_getStraightDistance}});
	...
	// v1 functions
	method("getCellDistance", ls::Method::Static, {{ls::Type::integer(), {ls::Type::any(), ls::Type::any()}, (void*) &map__getCellDistance}});
	method("getCellFromXY", ls::Method::Static, {{ls::Type::any(), {ls::Type::any(), ls::Type::any()}, (void*) &map__getCellFromXY}});
	method("getDistance", ls::Method::Static, {{ls::Type::real(), {ls::Type::any(), ls::Type::any()}, (void*) &map__getDistance}});
	method("getMapType", ls::Method::Static, {{ls::Type::integer(), {}, (void*) &map__getMapType}});
	method("getObstacles", ls::Method::Static, {{ls::Type::array(ls::Type::integer()), {}, (void*) &map__getObstacles}});
	...
	method("isOnSameLine", ls::Method::Static, {{ls::Type::boolean(), {ls::Type::any(), ls::Type::any()}, (void*) &map__isOnSameLine}});
